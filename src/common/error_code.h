...
#ifndef ZRPC_ERROR_CODE_H
#define ZRPC_ERROR_CODE_H
...
//
    ...
    const int ERROR_NOT_SET_ASYNC_PRE_CALL = SYS_ERROR_PREFIX(0011);           // you didn't set some necessary param before call async rpc
    const int ERROR_CONNECT_SYS_ERR        = SYS_ERROR_PREFIX(0012);           // connect sys error

}

#endif //ZRPC_ERROR_CODE_H
